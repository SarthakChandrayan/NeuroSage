...
const Dashboard = () => {
  ...
  const { mutate: deleteFile } = trpc.deleteFile.useMutation({
    ...
    onMutate(variables) {
      setCurrentlyDeletingFile(variables.id)
    },
    onSettled() {
  ...
  return (
    <main className='mx-auto max-w-7xl'>
      ...
      {files && files.length !== 0 ? (
        ...
        <div className='mt-16 flex flex-col items-center gap-4 py-8 max-w-xl mx-auto text-center'>
          ...
          <h3 className='font-semibold text-2xl'>Pretty empty around here</h3>
